...
setup(
    ...
    description='''Extension CKAN ( dcat, spatial)''',
    long_description=long_description,
    long_description_content_type="text/markdown",

    # The project's main homepage.
    url='https://github.com/ecolab/ckanext-ecospheres',

    # Author details
    author='''Ahmed Boukerram''',
    author_email='''as.boukerram@soprasterianext.com''',
    ...
    keywords='''CKAN dcat mte spatial''',
