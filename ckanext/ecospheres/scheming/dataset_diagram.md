...
flowchart LR
    ...
    dataset-->main([main]):::main
        ...
        main-->in_series1[in_series]:::nodeOrUri
            ...
            in_series1-->url1[url]:::uri
            in_series1-->uri1[uri]:::uri
        main-->series_member1[series_member]:::nodeOrUri
            series_member1-->title3[title]:::literal
            series_member1-->url2[url]:::uri
            series_member1-->uri2[uri]:::uri
    ...
    dataset-->tab1([Contacts et acteurs]):::tab
        tab1-->contact_point1[contact_point]:::node
        ...
        tab1-->qualified_attribution1[qualified_attribution]:::node
    ...
    dataset-->tab2([Documentation]):::tab
        tab2-->attributes_page1[attributes_page]:::uri
        tab2-->page1[page]:::nodeOrUri
            page1-->issued1[issued]:::literal
            page1-->created1[created]:::literal
            page1-->modified2[modified]:::literal
            page1-->url8[url]:::uri
            page1-->description1[description]:::literal
            page1-->title4[title]:::literal
            page1-->uri4[uri]:::uri
    dataset-->tab3([Détails]):::tab
        tab3-->created2[created]:::literal
        tab3-->issued2[issued]:::literal
        tab3-->category1[fa:fa-list category]:::uri
        tab3-->subcategory1[fa:fa-list subcategory]:::uri
        tab3-->free_tags1[free_tags]:::literal
        tab3-->is_primary_topic_of1[is_primary_topic_of]:::node
        ...
        tab3-->spatial_coverage1[spatial_coverage]:::nodeOrUri
        ...
        tab3-->access_rights1[access_rights]:::nodeOrUri
            access_rights1-->label2[label]:::literal
            access_rights1-->uri6[fa:fa-list uri]:::uri
        tab3-->crs1[fa:fa-list crs]:::uri
        tab3-->conforms_to1[conforms_to]:::nodeOrUri
            conforms_to1-->title6[title]:::literal
            conforms_to1-->uri7[fa:fa-list uri]:::uri
        tab3-->accrual_periodicity1[fa:fa-list accrual_periodicity]:::uri
        tab3-->language2[fa:fa-list language]:::uri
        tab3-->provenance1[provenance]:::literal
        tab3-->version1[version]:::literal
        tab3-->version_notes1[version_notes]:::literal
        tab3-->temporal_resolution1[temporal_resolution]:::literal
        tab3-->spatial_resolution1[spatial_resolution]:::literal
    dataset-->tab4([Export]):::tab
        tab4-->as_inspire_xml1[as_inspire_xml]:::uri
